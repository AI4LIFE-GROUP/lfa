...
from functions_model_training import FFNNClassification, DatasetFromCSV
...
#model
model = FFNNClassification(input_dim=train_ds.X.shape[1], n_nodes_per_layer=8)
...
ckpt_descrip=f'ffnnA_{dataset_name}'
